...
/**
 * Provides a form for deleting a lesson6 entity.
 *
 * @ingroup lesson6
 */
class CurrencyDeleteForm extends ContentEntityConfirmFormBase {
   ...
   * {@inheritdoc}
   *
   * If the delete command is canceled, return to the currency list.
   */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('lesson6')->notice('@type: deleted %title.',
      array(
